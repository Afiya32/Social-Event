...
const Login = () => {
  ...
  const handlegoogleLogin=()=>{
       ...
       toast.success("Congrats! log in successfully")
  }
  const handlelogIn=(e)=>{
    e.preventDefault();
    ...
    if(email,password){
      ...
      toast.error("please provider all information")
    }
  }
    return (
       ...
       <p className="mt-1 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
         Enter your information to the form.
       </p>
  ...
  reverseOrder={false}/></div>
       ...
       className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
         ...
         <div className=" w-full bg-gray-200 p-3">
            <div className="divide-blue-600">or</div>
            <h2 className="font-bold text-center m-1  text-lg">Log in with </h2>
            <button onClick={handlegoogleLogin} className="btn btn-outline m-2 text-blue-500 w-full p-5 ">
